...
interesadoMod.controller('interesadoListaControlador', ['$rootScope', '$scope', '$http', '$filter', '$timeout', '$q', 'UtilService', 'interesadoSrv', 'interesadoEventoSrv',
	function cargarInteresados($rootScope, $scope, $http, $filter, $timeout, $q, UtilService, interesadoSrv, interesadoEventoSrv) {
		$scope.GetOK = true;
