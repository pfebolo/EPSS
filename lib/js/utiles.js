...
EPSSApp.service('UtilService', function () {
	...
	this.obtenerAnioCursadoBase = function obtenerAnioCursadoBase(fechaBase ,promocion, cuatrimestre) {
	...
	this.obtenerAnioCursado = function obtenerAnioCursado(promocion, cuatrimestre) {
		...
		return this.obtenerAnioCursadoBase(fechaActual,promocion, cuatrimestre);
	};
