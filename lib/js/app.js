...
EPSSApp.config(['$locationProvider', '$routeProvider', function ($locationProvider, $routeProvider) {
	...
	$routeProvider
		...
		.when('/informeEdicion', {
			templateUrl: 'Partials/informeEdicion.html',
			controller: 'informeEdicionControlador'
		})
		.when('/preAsignacionDivision', {
			templateUrl: 'Partials/preAsignacionDivision.html',
			controller: 'preAsignacionDivisionControlador'
		})
		.when('/interesadoFicha', {
			templateUrl: 'Partials/interesadoFicha.html',
			controller: 'interesadoFichaControlador'
		})
		//.otherwise({
		//  redirectTo: '/menu'
		//})
