...
incripcionMod.controller('inscripcionControlador', ['$rootScope', '$scope', '$http', '$location', 'estudianteSrv',
	function cargarInteresados($rootScope, $scope, $http, $location, estudianteSrv) {
		...
		if (estudianteSrv.accion === accion_inscribir) {
			...
			$scope.interesadoSeleccionado.alumnoId = estudianteSrv.interesadoAInscribir.iteresadoId;
