...
grupoMod.factory('grupoSrv', ['$q', '$http', '$rootScope', '$location', 'UtilService',
	function ($q, $http, $rootScope, $location, UtilService) {
		...
		grupoService.exponerActaVolante = function exponerActaVolante(grupo) {
			grupoService.grupoAEditar = grupo;
			$location.path('/grupoActaVolante');
		};

		grupoService.exponerRegAsistencia = function exponerRegAsistencia(grupo) {
			grupoService.grupoAEditar = grupo;
			$location.path('/grupoRegAsistencia');
		};
