...
interesadoMod.controller('interesadoListaControlador',['$rootScope', '$scope', '$http', 'interesadoSrv', 'estudianteSrv',
	function cargarInteresados($rootScope, $scope, $http, interesadoSrv, estudianteSrv) {
		$scope.GetOK = true;
