	...
	describe('Service: UtilService', function () {
		...
		describe('Gestión de Errores', function () {
			...
			it('Debería obtener un error genérico', function () {
				...
				var responseErrorExpected = { mensajes: [{ codigo: 'Datos adicionales ', mensaje: '[sin datos adicionales]' }] };
				responseErrorExpected.mensajes.push({ codigo: 'HTTP Status ', mensaje: response.status });
				responseErrorExpected.mensajes.push({ codigo: 'HTTP StatusText ', mensaje: response.statusText });
				responseErrorExpected.mensajes.push({ codigo: 'url', mensaje: url });
				responseErrorExpected.mensajes.push({ codigo: 'verb', mensaje: verbo });
				var responseError= UtilService.getResponseError(response,url,verbo);
