...
interesadoMod.controller('interesadoControlador',['$rootScope', '$scope', '$http', '$location', 'interesadoSrv',
...
interesadoMod.controller('inscripcionControlador',['$rootScope', '$scope', '$http', '$location', 'interesadoSrv',
	function cargarInteresados($rootScope, $scope, $http, $location, interesadoSrv) {
		$scope.GetOK = true;
		$scope.cargando = false;
		$scope.myStyle = { cursor: 'wait' };
