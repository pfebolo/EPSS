...
inscriptoMod.controller('inscriptoListaControlador',['$rootScope', '$scope', '$http','estudianteSrv', 'legajoSrv',
	function CargarInscriptos($rootScope, $scope, $http, estudianteSrv, legajoSrv) {
		$scope.GetOK = false;
		$scope.cargando = true;
